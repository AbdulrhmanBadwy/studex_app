  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: StartQuizAppBar(
        ...
        onMenuPressed: () {
          // TODO: add an overflow menu or contextual actions for the quiz screen.
        },
      ...
      body: Column(
        children: [
          ...
          StartQuizTitleSection(
            ...
            subtitle:
                'يتضمن هذا الاختبار مفاهيم هندسة البرمجيات الأساسية، دورة حياة النظام، والنماذج المختلفة للتطوير. استعد جيداً!',
          ),
          ...
          StartQuizButton(
            label: 'بدء الجلسة الآن',
            onPressed: () => context.pushNamed(AppRoutes.takeQuiz),
          ),
        ],
      ),
    );
